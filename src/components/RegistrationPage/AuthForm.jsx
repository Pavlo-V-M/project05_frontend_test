...
import { GoEyeClosed, GoEye, GoX, GoCheckCircle } from 'react-icons/go';
      ...
      <BackgroundComponent>
        <div className={css.auth_form}>
          <h2 className={css.title}>
            {isRegistrationMode ? 'Registration' : 'Sign In'}
          </h2>
          <form onSubmit={handleSubmit(onSubmit)}>
            ...
            <div className={css.form_group}>
              ...
              {showNameField && formState.errors.name && (
                <span className={css.warning_message}>
            ...
            {/* Email input */}
            <div
              className={`${css.form_group} ${
                errors.email || formState.isSubmitted ? css.error : ''
              } ${formState.isValid ? css.ok : ''}`}
            >
              <div className={css.input_wrapper}>
                <input
                  type="email"
              ...
              {formState.isValid && (
                <span className={`${css.error_message} ${css.success_message}`}>
            ...
            <div
              className={`${css.form_group} ${
                errors.password || formState.isSubmitted ? css.error : ''
              } ${formState.isValid ? css.ok : ''}`}
            >
              <div className={css.input_wrapper}>
                <input
                  ...
                  {...register('password', {
                    ...
                    pattern: {
                      ...
                      message:
                        'This is an ERROR password/Password must contain at least 1 uppercase letter, 1 lowercase letter, and 1 number',
                    },
                  })}
                />
                <button
            ...
            <div className={css.buttons}>
              <button
                ...
                className={`${css.sign_button} ${
                  formState.isValid ? css.validButton : css.invalidButton
                }`}
                type="submit"
              >
