...
const Privacy = () => {
  ...
  }, [privacyModalOpen, termsModalOpen]);
  ...
  return (
    <div>
      <div className={css.privacy}>
        <p className={css.privacy_rights}>©2023 Drink Master. All rights reserved.</p>
        <p className={css.privacy_rules}> 
          <span onClick={openPrivacyModal} style={{ cursor: 'pointer' }} >
            Privacy Policy
          </span>
